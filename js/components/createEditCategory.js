...
export const createEditCategory = (app) => {
    ...
    const thHeadCellMain = createElement('th', {
        className: 'table__cell',
        textContent: 'main',
    });

    const thHeadCellSecond = createElement('th', {
        className: 'table__cell',
        textContent: 'second',
    });

    const thHeadCellEmpty = createElement('th', {
        className: 'table__cell',
        textContent: '',
    });
    ...
    thead.append(trHead);
    trHead.append(thHeadCellMain, thHeadCellSecond, thHeadCellEmpty);
